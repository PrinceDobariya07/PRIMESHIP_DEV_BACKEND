...
const mainOrderRoute = require("./mainOrder");
...
adminRoute.use("/mainOrder", verifyAdminToken(2), mainOrderRoute);
adminRoute.use("/address", verifyAdminToken(2), addressRoute);
adminRoute.get("/verify",verifyAdminToken(2))
